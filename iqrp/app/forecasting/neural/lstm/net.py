"""LSTM / BiLSTM / Stacked LSTM backbone."""
...
class LSTMNet(nn.Module if has_torch() else object):  # type: ignore[misc]
    def __init__(
        self,
        n_features: int,
        horizon: int,
        *,
        ...
        self.pos = PositionalEncoding(hidden_size) if use_positional else nn.Identity()
        self.rnn = nn.LSTM(
            hidden_size,
            hidden_size,
