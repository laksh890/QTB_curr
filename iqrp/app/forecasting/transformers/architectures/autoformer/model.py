...
from iqrp.app.forecasting.transformers.architectures.autoformer.net import AutoformerNet
from iqrp.app.forecasting.transformers.base.transformer_model import TransformerForecastModel


@register_forecast_model
class AutoformerForecastModel(TransformerForecastModel):
    architecture_name = "autoformer"
    meta = ForecastModelMeta(
        name="autoformer",
        version="1.0.0",
        description="Autoformer",
