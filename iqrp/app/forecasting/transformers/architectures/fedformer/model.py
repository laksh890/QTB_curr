...
from iqrp.app.forecasting.transformers.architectures.fedformer.net import FEDformerNet
from iqrp.app.forecasting.transformers.base.transformer_model import TransformerForecastModel


@register_forecast_model
class FEDformerForecastModel(TransformerForecastModel):
    architecture_name = "fedformer"
    meta = ForecastModelMeta(
        name="fedformer",
        version="1.0.0",
        description="FEDformer",
