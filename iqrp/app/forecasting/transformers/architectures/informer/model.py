"""Informer ProbSparse Transformer forecasting model."""
...
from iqrp.app.forecasting.transformers.architectures.informer.net import InformerNet
from iqrp.app.forecasting.transformers.base.transformer_model import TransformerForecastModel


@register_forecast_model
class InformerForecastModel(TransformerForecastModel):
    architecture_name = "informer"
    meta = ForecastModelMeta(
        name="informer",
        version="1.0.0",
        description="Informer ProbSparse Transformer",
