...
from iqrp.app.forecasting.transformers.architectures.itransformer.net import iTransformerNet
from iqrp.app.forecasting.transformers.base.transformer_model import TransformerForecastModel


@register_forecast_model
class iTransformerForecastModel(TransformerForecastModel):
    architecture_name = "itransformer"
