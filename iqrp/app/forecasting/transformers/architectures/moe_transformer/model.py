"""Mixture-of-Experts Transformer forecasting model."""
...
from iqrp.app.forecasting.transformers.architectures.moe_transformer.net import MoETransformerNet
from iqrp.app.forecasting.transformers.base.transformer_model import TransformerForecastModel


@register_forecast_model
class MoETransformerForecastModel(TransformerForecastModel):
    architecture_name = "moe_transformer"
    meta = ForecastModelMeta(
        name="moe_transformer",
        version="1.0.0",
        description="Mixture-of-Experts Transformer",
