...
from iqrp.app.forecasting.transformers.architectures.patchtst.net import PatchTSTNet
from iqrp.app.forecasting.transformers.base.transformer_model import TransformerForecastModel


@register_forecast_model
class PatchTSTForecastModel(TransformerForecastModel):
    architecture_name = "patchtst"
