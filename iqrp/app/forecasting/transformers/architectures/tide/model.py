...
from iqrp.app.forecasting.transformers.architectures.tide.net import TiDENet
from iqrp.app.forecasting.transformers.base.transformer_model import TransformerForecastModel


@register_forecast_model
class TiDEForecastModel(TransformerForecastModel):
    architecture_name = "tide"
