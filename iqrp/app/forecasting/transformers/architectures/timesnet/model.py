...
from iqrp.app.forecasting.transformers.architectures.timesnet.net import TimesNetNet
from iqrp.app.forecasting.transformers.base.transformer_model import TransformerForecastModel


@register_forecast_model
class TimesNetForecastModel(TransformerForecastModel):
    architecture_name = "timesnet"
    meta = ForecastModelMeta(
        name="timesnet",
        version="1.0.0",
        description="TimesNet",
