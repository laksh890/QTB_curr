"""CatBoost-specific training helpers."""
...
from iqrp.app.forecasting.tree_models.catboost.model import CatBoostForecastModel
...
class CatBoostTrainer:
    ...
    def fit(
        ...
        **params: Any,
        ...
        model = CatBoostForecastModel(settings=self.settings, **params)
